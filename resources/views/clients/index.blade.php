        ...
        <form action="{{ route('clients.store') }}" method="POST" class="modal-content">
            ...
            <div class="modal-body">
                <div class="row g-3">
                    ...
                    <div class="col-6">
                        <label class="fw-bold form-label">CI</label>
    ...
    <div class="modal-dialog">
        <form id="editClientForm" method="POST" class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3"><label class="form-label">CI</label><input type="text" name="document_number" id="edit_doc" class="form-control"></div>
